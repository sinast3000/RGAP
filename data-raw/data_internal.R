...
cubs$base <- data.frame(equation    = "cubs",
                        variant     = "base",
                        sysMatrix   = c("Z", "Z"),#, "Q"),
                        variableRow = c("const", "cycle"),#, "E2errorL0"),
                        varName     = c("cuConst", "cuC0"),#, "cuSigma"),
                        lowerBound  = c(-0.1, 1),#, 0),
                        upperBound  = c(0.1, 5),#, NA),
                        statRestr   = c(""),
                        mean        = c(0, 1.4),#, 5e-3),
                        std         = c(0.03, 0.7),#, 5e-3),
                        distribution = c("normal", "normal"),
...
pcInd$base <- data.frame(equation   = "pcInd",
                          ...
                          sysMatrix   = c("Z", "Z"),#, "Q"),
                          variableRow = c("const", "cycle"),#, "E2errorL0"),
                          varName     = c("pcConst", "pcC0"),#, "pcSigma"),
                          lowerBound  = c(-0.1, -10),#, 0),
                          upperBound  = c(0.1, 0),#, NA),
                          statRestr   = c(""),
                          mean        = c(0, -1),#, 5e-5),
                          std         = c(0.1, 0.5),#, 5e-5),
                         distribution = c("normal", "normal"),
